...
setup(name='pyTANSPEC',
      ...
      keywords='Spectrum Extraction For TANSPEC XD and LR modes',
      url='https://github.com/astrosupriyo/pyTANSPEC',
      author='Supriyo Ghosh', 'Varghese Reji',
      author_email='sbuphy2010@gmail.com', 'varghesereji0007@gmail.com',
      license='GPLv3+',
      packages=['pyTANSPEC','pyTANSPEC.libs'],
      entry_points = {
          'console_scripts': ['pyxdspec=pyTANSPEC.reduce_specXD:main',
                              'pylrspec=pyTANSPEC.reduce_specLR:main'],
      },
      install_requires=[
          'numpy',
          'astropy',
